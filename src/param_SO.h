...
c      parameter (NP_XI=16, NP_ETA=8, NSUB_X=1, NSUB_E=1)
c================   ALEX  
# ifdef SO_d05
c      parameter (NP_XI=16, NP_ETA=8, NSUB_X=1, NSUB_E=1)
c      parameter (NP_XI=45, NP_ETA=8, NSUB_X=1, NSUB_E=1)
c      parameter (NP_XI=24, NP_ETA=8, NSUB_X=1, NSUB_E=1)
c      parameter (NP_XI=24, NP_ETA=12, NSUB_X=1, NSUB_E=1)
c      parameter (NP_XI=12, NP_ETA=24, NSUB_X=1, NSUB_E=1)
c      parameter (NP_XI=12, NP_ETA=36, NSUB_X=1, NSUB_E=1)
c      parameter (NP_XI=8, NP_ETA=24, NSUB_X=1, NSUB_E=1)
c      parameter (NP_XI=6, NP_ETA=24, NSUB_X=1, NSUB_E=1)
c      parameter (NP_XI=16, NP_ETA=24, NSUB_X=1, NSUB_E=1)
c      parameter (NP_XI=12, NP_ETA=32, NSUB_X=1, NSUB_E=1)
      parameter (NP_XI=8, NP_ETA=36, NSUB_X=1, NSUB_E=1)
# endif
# ifdef SO_d025
c      parameter (NP_XI=48, NP_ETA=16, NSUB_X=1, NSUB_E=1)
c      parameter (NP_XI=12, NP_ETA=32, NSUB_X=1, NSUB_E=1)
      parameter (NP_XI=16, NP_ETA=24, NSUB_X=1, NSUB_E=1)
# endif
# ifdef SO_d0125
c      parameter (NP_XI=48, NP_ETA=16, NSUB_X=1, NSUB_E=1)
c      parameter (NP_XI=12, NP_ETA=32, NSUB_X=1, NSUB_E=1)
      parameter (NP_XI=32, NP_ETA=12, NSUB_X=1, NSUB_E=1)
c      parameter (NP_XI=32, NP_ETA=24, NSUB_X=1, NSUB_E=1)
c      parameter (NP_XI=32, NP_ETA=36, NSUB_X=1, NSUB_E=1)
c      parameter (NP_XI=32, NP_ETA=48, NSUB_X=1, NSUB_E=1)
# endif
c================ 
# ifdef ATLSMA
...
# else
c      parameter (NP_XI=4, NP_ETA=8, NSUB_X=1, NSUB_E=1)
# endif
...
#  ifdef SEDIMENT_BIOLOGY
     &     , NT_sed
#  endif
# endif /* BIOLOGY || BIOLOGY_NPZDOC || BIOLOGY_BEC || BIOLOGY_BEC2*/
# ifdef BIOLOGY
...
# ifdef BIOLOGY_BEC2
     ...
     &     , iPO4, iNO3, iSIO3, iNH4, iFE, iO2, iDIC,
     &     iALK, iDOC, iDON, iDOFE, iDOP, iDOPR, iDONR, iZOOC,
           ! autotroph indices
     &     iSPCHL, iSPC, iSPFE, iSPCACO3, iDIATCHL, iDIATC, iDIATFE,
     &     iDIATSI, iDIAZCHL, iDIAZC, iDIAZFE
# endif /* BIOLOGY_BEC2 */
      parameter (itemp=1
# ifdef SALINITY
     &           , isalt=2, ntrc_salt=1
