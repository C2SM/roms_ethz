...
#define GRID_SIZE LLm=350, MMm=225, N=42
...
!#define OBC_W_M2SPEC_STR  1/* OBC_M2SPECIFIED for all tiles*/
!#define OBC_W_M2SPEC_END  (NP_XI*NP_ETA) /* OBC_M2SPECIFIED for all tiles*/
!#define OBC_EAST
#define OBC_SOUTH
