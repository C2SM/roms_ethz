...
# define RIVER_LOAD_N
# define RIVER_LOAD_P
# define RIVER_LOAD_BIO /* FD: need this switch to have the N,P river load; having RIVER_LOAD_N and RIVER_LOAD_P switched on is not enough due to initialization extra code in ecosys_bec2.F  */
