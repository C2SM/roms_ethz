...
#define GRID_SIZE LLm=679, MMm=567, N=42
...
#define OBC_W_M2SPEC_STR 1 /* OBC_M2SPECIFIED (specify barotropica component... */
#define OBC_W_M2SPEC_END (NP_XI*NP_ETA) /*... For the upper half of domain i.e. SO in and IndT  */
