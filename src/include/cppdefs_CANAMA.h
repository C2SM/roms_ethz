/*
  UP ETH Canarys Ocean Setup (AMACANC grid, PACTCS parameter)
  == === ====== ===== =====
...
#define LMD_BKPP
     ...
     /* Biology */
#ifdef BIOLOGY_BEC2
# define DAILYPAR_BEC  /* PACTCS */
# define USE_EXPLICIT_VSINK /* PACTCS */
# define DEFAULT_BRY_VALUES /* PACTCS */
! -- # define MULT_CLIM_FILES
! # define BUDGETVARS
# define VFLX_CORR /* MF: make sure this is always on if running with BIOLOGY */
# define BEC2_DIAG
! -- AMACANC # define BEC_DDA
! -- AMACANC # define BEC_DDA_case2
! # define BEC_DDA_case1
! -- AMACANC # define AMAZON_PAR
! -- PACTCS # define RIVER_LOAD_ALK_DIC_SI
# define RIVER_LOAD_N
# define RIVER_LOAD_P
