...
#include "cppdefs_UP.h"
                     ...
                     /* Resolution (section with HUMPAC added by EK) */
...
# define GRID_SIZE    LLm=699, MMm=1007, N=64           /* changed from N=42 to N=64 by EK  */
# define DOMAIN_TILING NP_XI=8, NP_ETA=48, NSUB_X=1, NSUB_E=1
#endif
/* Open Boundaries */
#define OBC_WEST    /* Open boundary in the west   */
!--#define OBC_NORTH   /* Closed boundary in the north  */
!--#define OBC_EAST /* Closed boundary in the east */
!--#define OBC_SOUTH   /* Closed boundary to the south  */
