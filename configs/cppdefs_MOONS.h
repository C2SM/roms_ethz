/* 
  UP ETH Moorea North Shore (MOONS)
  == === ====== ===== ===== =======
*/
...
! Moorea north shore
#define GRID_SIZE LLm=319, MMm=320, N=10      ! pactcs60 8-120km telescopic up to Antarctica
#define DOMAIN_TILING NP_XI=8, NP_ETA=18, NSUB_X=1, NSUB_E=1 ! Euler 

     /* Open Boundaries */
!pactcs #define OBC_SOUTH
#define OBC_EAST
#define OBC_NORTH
#define OBC_WEST
...
! change standard settings in set_global_definition.h here:
